...
{
    if(fLiteMode) return; // ignore all TDC related functionality
...
/*
    ...
    allow endless transaction that would bloat TDC and make it unusable. To
...
{
    if(fLiteMode) return; // disable all TDC specific functionality
