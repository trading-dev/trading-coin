...
const char * const BITCOIN_CONF_FILENAME = "TDC.conf";
const char * const BITCOIN_PID_FILENAME = "TDCd.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\TDCCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\TDCCore
    // Mac: ~/Library/Application Support/TDCCore
    // Unix: ~/.TDCcore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "TDCCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/TDCCore";
#else
    // Unix
    return pathRet / ".TDCcore";
#endif
#endif
}
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty TDC.conf if it does not excist
