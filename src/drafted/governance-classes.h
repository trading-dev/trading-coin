 ...
 *
 *   // network
 *   CTDCNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.TDC.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CTDCNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: TDCNetwork
// //   -- signature requirements : Key1(User)
// class CTDCNetworkVariable : public CGovernanceObject
// {
// private:
