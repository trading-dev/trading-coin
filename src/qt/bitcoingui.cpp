    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("TDC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About TDC Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TDC Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the TDC Core help message to get a list with possible TDC Core command-line options"));
