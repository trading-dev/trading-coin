...
//
// OSX-specific way of handling TDC: URIs and PaymentRequest mime types.
...
bool PaymentServer::processPaymentRequest(const PaymentRequestPlus& request, SendCoinsRecipient& recipient)
{
    ...
    Q_FOREACH(const PAIRTYPE(CScript, CAmount)& sendingTo, sendingTos) {
        ...
        if (ExtractDestination(sendingTo.first, dest)) {
            ...
            // Unauthenticated payment requests to custom TDC addresses are not supported
        ...
        // TDC amounts are stored as (optional) uint64 in the protobuf messages (see paymentrequest.proto),
