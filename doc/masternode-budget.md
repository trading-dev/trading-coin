...
Format: ```mngovernance prepare proposal-name url payment-count block-start TDC-address monthly-payment-TDC```
...
Format: ```mngovernance submit proposal-name url payment-count block-start TDC-address monthly-payment-TDC fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using TDC.conf setup)
